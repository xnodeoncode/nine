...
namespace Nine.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260816145144_AddPropertyExpense")]
    partial class AddPropertyExpense
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Nine.Core.Entities.MaintenanceRequest", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Nine.Core.Entities.Note", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Nine.Core.Entities.Organization", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Nine.Core.Entities.OrganizationEmailSettings", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Nine.Core.Entities.OrganizationSMSSettings", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Nine.Core.Entities.OrganizationSettings", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Nine.Core.Entities.OrganizationUser", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Nine.Core.Entities.Payment", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Nine.Core.Entities.Property", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Nine.Core.Entities.PropertyExpense", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Nine.Core.Entities.ProspectiveTenant", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Nine.Core.Entities.RentalApplication", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Nine.Core.Entities.Repair", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Nine.Core.Entities.SchemaVersion", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Nine.Core.Entities.SecurityDeposit", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Nine.Core.Entities.SecurityDepositDividend", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Nine.Core.Entities.SecurityDepositInvestmentPool", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Nine.Core.Entities.Tenant", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Nine.Core.Entities.Tour", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Nine.Core.Entities.UserProfile", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Nine.Core.Entities.WorkflowAuditLog", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Nine.Core.Entities.ApplicationScreening", b =>
                {
                    b.HasOne("Nine.Core.Entities.RentalApplication", "RentalApplication")
                        .WithOne("Screening")
                        .HasForeignKey("Nine.Core.Entities.ApplicationScreening", "RentalApplicationId")
            ...
            modelBuilder.Entity("Nine.Core.Entities.CalendarEvent", b =>
                {
                    b.HasOne("Nine.Core.Entities.Property", "Property")
                        .WithMany()
            ...
            modelBuilder.Entity("Nine.Core.Entities.Checklist", b =>
                {
                    b.HasOne("Nine.Core.Entities.ChecklistTemplate", "ChecklistTemplate")
                        .WithMany("Checklists")
                    ...
                    b.HasOne("Nine.Core.Entities.Lease", "Lease")
                        .WithMany()
            ...
            modelBuilder.Entity("Nine.Core.Entities.ChecklistItem", b =>
                {
                    b.HasOne("Nine.Core.Entities.Checklist", "Checklist")
                        .WithMany("Items")
            ...
            modelBuilder.Entity("Nine.Core.Entities.Document", b =>
                {
                    b.HasOne("Nine.Core.Entities.Invoice", "Invoice")
                        .WithMany()
                    ...
                    b.HasOne("Nine.Core.Entities.Payment", "Payment")
                        .WithMany()
                    ...
                    b.HasOne("Nine.Core.Entities.Tenant", "Tenant")
                        .WithMany()
            ...
            modelBuilder.Entity("Nine.Core.Entities.LeaseOffer", b =>
                {
                    ...
                    b.HasOne("Nine.Core.Entities.ProspectiveTenant", "ProspectiveTenant")
                        .WithMany()
            ...
            modelBuilder.Entity("Nine.Core.Entities.NotificationPreferences", b =>
                {
                    b.HasOne("Nine.Core.Entities.Organization", "Organization")
                        .WithMany()
                        .HasForeignKey("OrganizationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Nine.Core.Entities.ProspectiveTenant", b =>
                {
                    b.HasOne("Nine.Core.Entities.Property", "InterestedProperty")
                        .WithMany()
            ...
            modelBuilder.Entity("Nine.Core.Entities.Repair", b =>
                {
                    ...
                    b.HasOne("Nine.Core.Entities.MaintenanceRequest", "MaintenanceRequest")
                        .WithMany("Repairs")
            ...
            modelBuilder.Entity("Nine.Core.Entities.SecurityDepositDividend", b =>
                {
                    b.HasOne("Nine.Core.Entities.SecurityDepositInvestmentPool", "InvestmentPool")
                        .WithMany("Dividends")
                    ...
                    b.HasOne("Nine.Core.Entities.SecurityDeposit", "SecurityDeposit")
                        .WithMany("Dividends")
